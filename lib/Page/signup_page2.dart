...
class _SignupPage2State extends State<SignupPage2> {
  ...
  Future<void> createAccount() async {
    Client client = Client(lastname: this.lastname, firstname: this.firstname, mail: this.mail, password: this.password, country: this.pays ?? "", department: this.departement ?? "", postalCode: this.codePostal ?? "", city: this.ville ?? "", address: this.adresse ?? "", admin: false, id: 1 );
